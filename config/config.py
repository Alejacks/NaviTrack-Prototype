...
- Methods to check if the configuration values are valid (and exceptions for errors in this case) - config.py / Done
- Method to validate the configuration values and raise an exception if they are invalid - config.py / Done
- Method to access the configuration values from the dictionary - config.py / Done
- Method to access the configuration values from a dictionary inside a dictionary (and so on) - config.py based on utils.py methods to get values from a dictionary inside a dictionary... / Done (but in a much simpler manner)

- Custom exceptions for different errors - exceptions.py / Done
